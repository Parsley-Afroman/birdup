    ...
    return (
        <div id={id} className={formType}>
            ...
            <form id={formName} method='post' target="maintainFrame">
                <FormInput type={'text'} name={'name'} setFormData={setFormData} label={'What is my name?'} value={formData.name} placeholder={'Call me...'}/>
                <FormInput type={'text'} name={'origin'} setFormData={setFormData} label={'Where am I from?'} value={formData.origin} placeholder={'I hail from...'}/>
                <FormInput type={'text'} name={'diet'} setFormData={setFormData} label={'What do I love to eat?'} value={formData.diet} placeholder={'... is delicious!'}/>
                <FormInput type={'number'} name={'age'} setFormData={setFormData} label={'How old am I?'} min={1} max={999} value={formData.age} placeholder={'... years young!'}/>
                <FormInput type={'radio'} name={'real'} setFormData={setFormData} label={'Did you make me up?'} value={0} value2={1}/>
                <FormInput type={'range'} name={'abilities'} setFormData={setFormData} label={'Strength'} label2={'Intelligence'} min={0} max={10}/>
                <FormInput type={'text'} name={'image'} setFormData={setFormData} label={'Upload my image:'} placeholder={'I look rather dashing!'}/>
            </form>
